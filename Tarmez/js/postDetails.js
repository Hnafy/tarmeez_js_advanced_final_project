...
// goto main page and get the same position at post
// refresh posts to fixed send box hide or show --done
// hide main_posts_post_sendComment if user not login --done
// make return button to before page (index.html) --done